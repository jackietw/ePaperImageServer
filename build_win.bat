...
try:
    ...
    print('Downloading Anything V4.0 (Anime) model...')
    StableDiffusionPipeline.from_pretrained('andite/anything-v4.0', safety_checker=None, requires_safety_checker=False, cache_dir='models')
